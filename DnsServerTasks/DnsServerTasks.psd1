#
# Module manifest for module 'DnsServerTasks'
#
...
@{
    ...
    PrivateData          = @{
        ...
        PSData = @{
            ...
            Tags                       = @('powershell', 'dsc', 'composite resource', 'configuration', 'dns server')

            # A URL to the license for this module.
            # LicenseUri = ''

            # A URL to the main website for this project.
            ProjectUri                 = 'https://prod1gitlab.mapcom.local/dsc/configurations/DnsServerTasks.git'
